...
Machine Learning model for predicting academic performance using Python and Scikit-Learn.

### Network Traffic Analyzer
Python-based project for monitoring and analyzing network packets.
